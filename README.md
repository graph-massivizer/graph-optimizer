...
## Docker image
For experimentation with Graph-Optimizer, without a setup or requirements, you can run a docker image with the following command to experience its latest features, including GPU support:

sudo docker run -p 7777:7777 -it --gpus all --privileged dbartutw/graph-optimizer-beta-testing-gpu

Then open your browser and visit localhost:7777
<!-- 
## Tests
**TESTS PARAGRAPHS** -->
