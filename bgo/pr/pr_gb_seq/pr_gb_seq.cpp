...
int pr_gb_seq(LAGraph_Graph G, GrB_Vector *PR) {
    float damping = 0.85;
    int iter = 100;

    int32_t nthreads_max = 1;
    GxB_Context_set(GxB_CONTEXT_WORLD, GxB_CONTEXT_NTHREADS, nthreads_max);
