...
TRANSLATIONS = {
    ...
    'CSR&': {
        'decl': 'Reader<int32_t> r = Reader<int32_t>(argv[{i}]); bool needs_weights = false; pvector<SGEdge> el = r.ReadFile(needs_weights); BuilderBase<int32_t> b = BuilderBase<int32_t>(); CSRGraph<int32_t> arg_{i};',
        'init': 'arg_{i} = b.MakeGraphFromEL(el);',
        'name': 'arg_{i}'
    },
    'EdgeListStruct&': {
        'decl': 'Reader<int32_t> r = Reader<int32_t>(argv[{i}]); bool needs_weights = false; pvector<SGEdge> el = r.ReadFile(needs_weights); BuilderBase<int32_t> b = BuilderBase<int32_t>(); CSRGraph<int32_t> g = b.MakeGraphFromEL(el); EdgeListStruct arg_{i};',
        'init': 'arg_{i} = g.MakeEdgeListStruct();',
        'name': 'arg_{i}'
    },
    'EdgeStructList&': {
        'decl': 'Reader<int32_t> r = Reader<int32_t>(argv[{i}]); bool needs_weights = false; pvector<SGEdge> el = r.ReadFile(needs_weights); BuilderBase<int32_t> b = BuilderBase<int32_t>(); CSRGraph<int32_t> g = b.MakeGraphFromEL(el); EdgeStructList arg_{i};',
        'init': 'arg_{i} = g.MakeEdgeStructList();',
        'name': 'arg_{i}'
    },
    'SourcePicker<Graph>&': {
